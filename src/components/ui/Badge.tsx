...
const STATUS_CONFIG: Record<string, { label: string; bg: string; text: string; dot?: string }> = {
    ...
    POR_DESPACHAR: { label: 'Por despachar', bg: 'bg-orange-50', text: 'text-orange-700', dot: 'bg-orange-500' },
    ...
    ARCHIVADO: { label: 'Finalizado', bg: 'bg-gray-100', text: 'text-gray-500', dot: 'bg-gray-400' },
